    ...
    <header className="sticky top-0 z-40 bg-white border-b border-neutral-200 px-4 lg:px-6 h-16 flex items-center justify-between shadow-xs">
      ...
      <div className="flex items-center gap-4">
        ...
        >
          ...
          <div>
            ...
            <p className="text-[11px] text-neutral-500 font-medium truncate max-w-[180px] sm:max-w-none">
        ...
        {schedulingConflicts.length > 0 && (
          ...
          >
            ...
            <span>{schedulingConflicts.length} Assignment Conflict{schedulingConflicts.length > 1 ? 's' : ''}</span>
          </button>
        )}
      </div>
      ...
      <div className="flex-1 max-w-md mx-4 hidden md:block">
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <span className="text-neutral-400 text-xs font-normal">Search tournaments, players (TT-...), matches, clubs...</span>
          </div>
      ...
      <div className="flex items-center gap-2 sm:gap-3">
        ...
        <button
          ...
          onClick={() => onNavigate('public_tournament')}
          className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium border transition-colors ${
            currentView === 'public_tournament'
        ...
        <button
          ...
          onClick={() => onNavigate('venue_display')}
          className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium border transition-colors ${
            currentView === 'venue_display'
        ...
        >
          ...
          <span className="hidden sm:inline">TV Arena Mode</span>
        </button>

        {/* Claim Profile button if in player mode or not linked */}
          ...
          {showRoleDropdown && (
            <div className="absolute right-0 mt-2 w-64 bg-white border border-neutral-200 rounded-xl shadow-xl p-2 z-50">
              <div className="px-2 py-1.5 border-b border-neutral-100 mb-1">
                <p className="text-[11px] font-medium text-neutral-400 uppercase tracking-wider">Switch Active Role</p>
                <p className="text-xs text-neutral-700 font-medium mt-0.5">Test role-based permissions & dashboards</p>
              </div>
              ...
              <div className="mt-2 pt-2 border-t border-neutral-100">
                <p className="text-[11px] font-medium text-neutral-400 px-2 uppercase tracking-wider">Simulate User Account</p>
                  ...
                  {users.map(u => (
                    <button
                      ...
                      className={`w-full text-left px-2 py-1 rounded text-xs flex items-center gap-2 ${
                        currentUser.id === u.id ? 'bg-blue-50 text-blue-800 font-medium' : 'text-neutral-600 hover:bg-neutral-50'
                      }`}
                    >
